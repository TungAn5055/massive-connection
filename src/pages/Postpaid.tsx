...
const [valueIdentity, setValueIdentity] = useState(null)
  ...
  const options = [{value: "RUC", label: "RUC"}, {value: "DNI", label: "DNI"}]
  ...
  return (
      <>
        ...
        <Row className='site-page-content'>
          <Form className={"form-search-customer"} form={form} name="advanced_search" style={formStyle} onFinish={onFinish}>
            <fieldset>
              ...
              {
                  valueType && valueIdentity && checkFalseIdentity && (<div style={{
                    color: "#d71e1f",
                    display: "flex",
